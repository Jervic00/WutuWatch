...
@section('pageTitle', 'My Watchlists') 
    ...
    <div class="container bg-overlay-1 my-4 min-vh-100 pos-relative pb-5">
        ...
        <div class="row g-0 movie-list mb-2" id="watchlist">
            ...
            <div class="col-md my-2 d-flex justify-content-center pos-relative">
                    ...
                    <form action="{{ route($watchlist->media_type .'.watchlist', ['id' => $watchlist->movieId , 'media_type' => $watchlist->media_type]) }}" method="post">
                        @csrf
                        @method('DELETE')
                        <button class="btn m-0 p-0 delete-watchlist">
                            <span class="d-flex align-items-center"><i class="fas fa-bookmark fa-2x remove-watchlist" style="color: #399"></i></span>
                        </button>
                    </form>
